...
export function init(scene, size, id, offset, texture) {
    ...
    function makeBuilding(x,z,type){
        const heiht = [2,2,7,4,5];
        const bldgH = heiht[type]*5;
    ...
    makeBuilding(40,8,3);
    makeBuilding(10,-15,1);
    makeBuilding(89,50,2)
    // コース(描画)
